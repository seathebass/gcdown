...
This project was inspired by the [bookdown](https://github.com/rstudio/bookdown) and [thesisdown](https://github.com/ismayc/thesisdown) packages. In doing so, this package aims to provide PhD students and potentially master's students who are familiar with bookdown an option to use bookdown to write their respective dissertations or theses.

Currently the package is in development and relies on some modifications of the LaTeX template in order to get things working correctly in bookdown. This package is still relatively experimental but should be more complete as I continue working forward on finishing my dissertation as well. 
...
|City University of New York Graduate Center | [seathebass/gcdown](https://github.com/seathebass/gcdown)                                |[ismayc/thesisdown](https://github.com/ismayc/thesisdown)]
