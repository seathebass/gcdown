...
division: 'Your Department here'
advisor: 'My advisor'
year: '20XX'
executive: 'executive officer here'
department: 'My subject matter here'
...
params:
  'Install needed packages for {gcdown}': True
  
# Remove the hashtag to specify which version of output you would like.
# Can only choose one at a time.
output:
  gcdown::thesis_pdf: default 
...
preface: |
  This is an example of a thesis setup to use the graduate center document class 
...
if (!require(gcdown)) {
  if (params$`Install needed packages for {gcdown}`) {
    remotes::install_github("seathebass92/gcdown")
  } else {
    stop(
      paste(
        "You need to run",
